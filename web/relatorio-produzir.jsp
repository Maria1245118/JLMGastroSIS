...
<jsp:include page = "header-simples.jsp">
    <jsp:param name="tituloPagina" value="Vendas Aguardando Produção" />
</jsp:include>
                <h1>Vendas Aguardando Produção</h1>
                <%
                    List <Venda> vendas = new ArrayList<>();
                    vendas = Venda.consultarProduzir(false);
                %>
                            ...
                            <% for (Venda venda : vendas) { %>
                                ...
                                <tr>
                                    <td colspan="5" style="padding-bottom: 10px;">
                                        <table class="tabela-relatorio" style="border-bottom: 1px solid black; border-top: 1px dashed black; width: 100%;">
                                            <thead>
        ...
        <script>
            function gerarRelatorio() {
                var vRelatorio = "relatorio-produzir.jsp";
                window.print();
            }
        </script>
